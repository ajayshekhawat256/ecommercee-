...
export default function Product() {
  ...
  const sizeValue = searchParams.get("sizeValue");
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="lg:col-span-4 w-full">
                <div className="flex flex-wrap justify-center bg-white py-5 rounded-md">
                  {console.log(customersProduct.products.content + "this us product")}
                  {customersProduct.products && customersProduct.products?.content?.map((item) => (
                    <ProductCard Eachproducts={item} />
                  ))}
                </div>
              </div>
            </div>
          ...
          <section className='w-full px-[3.6rem'>
            <div className='mx-auto px-4 py-5 flex justify-center shadow-lg border rounded-md'>
              <Pagination count={customersProduct.products?.totalPages} color='secondary' onChange={handlePaginationChange}/>
            </div>
          </section>
        </main>
      </div>
