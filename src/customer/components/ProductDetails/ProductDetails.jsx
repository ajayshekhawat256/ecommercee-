...
export default function ProductDetails() {
    ...
    const handleAddToCart = () => {
        const data={productId:params.productId,size:setSelectedSize}
        console.log(data);
            ...
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="overflow-hidden rounded-lg max-w-[30rem] max-[35rem]">
                            <img
                    ...
                    lg:pb-24 ">
                        <div className="lg:col-span-2">
                            <h1 className="text-lg lg:text-xl font-semifold text-gray-900">{customersProduct.product?.brand}</h1>
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>{customersProduct.product?.title}</h1>
                        </div>
                    ...
                    <div className="border p-5">
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    <Rating value={4.0} precision={.5} readOnly />
                                    <p className='opacity-60'>2424224 Ratings</p>
                                </div>
                                <Box className="mt-5  space-y-3">
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }}
                                                variant='determinate' value={25} className='bg-yellow-300' />
                                        </Grid>
                                    </Grid>
                                    <Grid container alignItems="center" gap={2}>
                                        <Grid item xs={2}>
